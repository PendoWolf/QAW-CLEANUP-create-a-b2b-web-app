    ...
    try {
      ...
      if (name === "increment" || name === "decrement") {
        trackEvent(name, {
          ...
          previous_value: previousCounter,
          lastAction: newState.lastAction,
        });
      } else if (name === "reset") {
        trackEvent(name, {
          previous_counter_value: previousCounter,
          counter_value: newState.counter,
        });
      ...
      // Track counter action failures for analytics
      if (typeof window !== "undefined") {
        window.pendo?.track?.("counter_action_failed", {
          action_name: name,
          error_message: errorMessage.substring(0, 100),
          counter_value_at_failure: previousCounter,
        });
      }
    }
  };
